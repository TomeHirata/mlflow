...
Supported resources include `Experiment`, `Registered Model`, `Scorer`, and `Webhook`.
...
Required Permissions for accessing webhooks:

:::note
When a user creates a webhook, they automatically receive `MANAGE` permission on it. Other users can be granted access through the webhook permission management APIs.
:::
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#create-webhook-permission" target="_blank">
          <span>Create Webhook Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/webhooks/permissions/create`</td>
      <td>`POST`</td>
      <td>can_manage</td>
    </tr>
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#get-webhook-permission" target="_blank">
          <span>Get Webhook Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/webhooks/permissions/get`</td>
      <td>`GET`</td>
      <td>can_manage</td>
    </tr>
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#update-webhook-permission" target="_blank">
          <span>Update Webhook Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/webhooks/permissions/update`</td>
      <td>`PATCH`</td>
      <td>can_manage</td>
    </tr>
    <tr>
      <td>
        <Link to="/api_reference/auth/rest-api.html#delete-webhook-permission" target="_blank">
          <span>Delete Webhook Permission</span>
        </Link>
      </td>
      <td>`2.0/mlflow/webhooks/permissions/delete`</td>
      <td>`DELETE`</td>
      <td>can_manage</td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`2.0/mlflow/webhooks/{webhook_id}`</td>
      <td>`DELETE`</td>
      <td>Automatically deletes all associated permissions.</td>
    </tr>
  </tbody>
</table>
